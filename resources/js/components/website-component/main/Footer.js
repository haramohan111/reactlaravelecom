      ...
      <div className="container">
        ...
        <div className="col-xs-12 col-sm-6 no-padding">
          <div className="clearfix payment-methods">
            <ul>
              <li><img src="frontend/images/payments/1.png" alt="" /></li>
              <li><img src="frontend/images/payments/2.png" alt="" /></li>
              <li><img src="frontend/images/payments/3.png" alt="" /></li>
              <li><img src="frontend/images/payments/4.png" alt="" /></li>
              <li><img src="frontend/images/payments/5.png" alt="" /></li>
            </ul>
          </div>
          {/* /.payment-methods */} 
        </div>
